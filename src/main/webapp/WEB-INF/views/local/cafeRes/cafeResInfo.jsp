...
<body>
  ...
  <div class="container">
    ...
    <h2 class="mt-4 mb-3">카페 이름<!-- Contact -->
     &nbsp; 
      <small>카페 소개</small>
    </h2>
<!-- 
    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-4">
        ...
        <p>
          <abbr title="Hours">영업시간</abbr>: 월요일 - 금요일 
          <br/> 9:00 AM -  5:00 PM
        </p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#">
          <img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/jejuCafeRes/missing.jpg" alt="">
        </a>
      </div>
