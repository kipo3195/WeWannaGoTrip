		...
		<form onsubmit="submitJoinForm(this); return false;"
			...
			<div class="input-groups">
				...
				<input type="text" id="mid"
					   placeholder="「아이디」" name="mid" autofocus="autofocus" required />
			</div>
			<div class="input-groups">
				<label for="mpw">Password</label> 
				<input type="password" id="mpw"
					   placeholder="「비밀번호」" name="mpw" required />
			</div>
			<div class="input-groups">
			...
			<div class="input-groups">
				...
				<input type="text" id="mname"
					   placeholder="「이름」" name="mname" required />
			</div>
			<div class="input-groups">
				<label for="email">E-Mail</label> 
				<input type="email" id="email"
					   placeholder="「이메일」" name="memail" required />
			</div>
			<div class="input-groups">
