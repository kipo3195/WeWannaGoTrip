  ...
  <div class="container">
   ...
   <form onsubmit="submitLoginForm(this); return false;"
 	...
 	<div class="input-groups" >
 		...
 		<input  type="text" class="input" placeholder="「아이디」" name="mid"
 	...
 	<div class="input-groups">
 		<input style="width : 400px; margin: auto; position : relative; margin : 5px;" 
 	 	       class="button" type="submit" value="Sign In"/>
  	    <input style="width : 400px; margin: auto; position : relative; margin : 5px;"
